...
*Length target: fits in one Telegram message (~4000 chars). Currently ~2100 chars.*
*Format: plain text with light Markdown so it renders cleanly in Telegram.*
*Alternate versions preserved in `north_public_intro_alternates.md`.*
